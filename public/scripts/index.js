    ...
    await fetch(url, requestOptions)
        ...
        if (data.error)
            ...
            app.style.display = "flex",
                ...
                <img class="menu_brandicon" src="./assets/pictures/Netliinks_login_logo.png" alt="NETLIINKS LOGO">
                <span class="menu_brandname">NETGUARD</span>
                <span class="menu_username">${data.username}</span>

                <div class="menu_item menu_item-isActive" onclick="renderBusiness()">
                ...
                <div class="menu_item" onclick="renderUsers()">
                    <div class="menu_item_icon">
